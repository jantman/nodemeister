...
SELECT pg_catalog.setval('enc_groupclass_id_seq', 1, true);
...
SELECT pg_catalog.setval('enc_groupparameter_id_seq', 2, true);
...
SELECT pg_catalog.setval('fullhistory_fullhistory_id_seq', 11, true);
...
SELECT pg_catalog.setval('fullhistory_request_id_seq', 7, true);
