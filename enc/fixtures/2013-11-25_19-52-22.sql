...
SELECT pg_catalog.setval('enc_node_groups_id_seq', 6, true);
...
SELECT pg_catalog.setval('fullhistory_fullhistory_id_seq', 24, true);
...
SELECT pg_catalog.setval('fullhistory_request_id_seq', 16, true);
