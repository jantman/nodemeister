...
SELECT pg_catalog.setval('enc_node_groups_id_seq', 2, true);
...
SELECT pg_catalog.setval('fullhistory_fullhistory_id_seq', 14, true);
...
SELECT pg_catalog.setval('fullhistory_request_id_seq', 9, true);
