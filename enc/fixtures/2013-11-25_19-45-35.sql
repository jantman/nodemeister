...
SELECT pg_catalog.setval('enc_node_groups_id_seq', 1, true);
...
SELECT pg_catalog.setval('fullhistory_fullhistory_id_seq', 13, true);
...
SELECT pg_catalog.setval('fullhistory_request_id_seq', 8, true);
