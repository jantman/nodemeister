...
1	pbkdf2_sha256$10000$xDmVXlPMRQsp$kCcoRNiEs1ifvVmEd1cENle4UMWRee9GvupDHX+KlRg=	2013-11-24 22:10:14.806124-05	t	admin			admin@example.com	t	t	2013-11-24 22:10:14.806124-05
\.
...
SELECT pg_catalog.setval('enc_classexclusion_id_seq', 1, false);
...
SELECT pg_catalog.setval('enc_group_id_seq', 1, false);
...
SELECT pg_catalog.setval('enc_groupclass_id_seq', 1, false);
...
SELECT pg_catalog.setval('enc_groupparameter_id_seq', 1, false);
...
SELECT pg_catalog.setval('enc_node_groups_id_seq', 1, false);
...
SELECT pg_catalog.setval('enc_node_id_seq', 1, false);
...
SELECT pg_catalog.setval('enc_nodeclass_id_seq', 1, false);
...
SELECT pg_catalog.setval('enc_nodeparameter_id_seq', 1, false);
...
SELECT pg_catalog.setval('fullhistory_fullhistory_id_seq', 1, false);
...
SELECT pg_catalog.setval('fullhistory_request_id_seq', 1, false);
