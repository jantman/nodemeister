...
SELECT pg_catalog.setval('enc_nodeparameter_id_seq', 1, true);
...
SELECT pg_catalog.setval('fullhistory_fullhistory_id_seq', 3, true);
...
SELECT pg_catalog.setval('fullhistory_request_id_seq', 2, true);
