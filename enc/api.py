...
class NodeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Node
        fields = ('hostname','description','groups','excluded_groups','parameters','classes','excluded_params','excluded_classes')
...
class GroupSerializer(serializers.ModelSerializer):
    class Meta:
        model = Group
        fields = ('name','description','groups','parents','parameters','classes','parameters','classes')
...
class GroupClassSerializer(serializers.ModelSerializer):
    class Meta:
        model = GroupClass
        fields = ('group','classname','classparams')
